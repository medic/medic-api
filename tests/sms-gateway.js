...
exports.tearDown = function (callback) {
  ...
  restoreStub(recordUtils.createRecord);
  callback();
};
...
exports['post() should save WT messages to DB'] = function(test) {
  // given
  var createRecord = sinon.stub(recordUtils, 'createRecord');
...
exports['post() should continue processing other stuff if saving a wt message fails' ] = function(test) {
  // given
  var createRecord = sinon.stub(recordUtils, 'createRecord');
  createRecord.callsArgWith(1, new Error('testing createRecord failure'));
